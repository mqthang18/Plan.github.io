const data = `
    <div id="HQ" style="min-height: 300px;">
        <h2>Đánh giá chất lượng sinh cảnh - tóm tắt kết quả: <a href="https://docs.google.com/forms/d/1GA-fs4wv9yP0p14KHl0WzkyEN2wRSSS53XJMa4LnPmA/viewanalytics" target="_blank">Link</a></h2>
        <ol>
            <li id="HQ1">
            ...
            <li id="HQ5">
                <button type="button" id="collapsible" class="collapsible">Biểu diễn khu vực phân bố của các nhân tố</button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
                        <li>
                            <h5>Sóc Trăng</h5>
            ...
            <li id="HQ6">
                <button type="button" id="collapsible" class="collapsible">Mô tả những đổi sinh cảnh trong tương lai</button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
                        <li>
                            <h5>Sóc Trăng<h5>
                            <iframe style="width: 100%; height: 320px;" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSVIrpQmW0JWTuRDy3CQ6S8T38-reoZRLy6SNm0Gz_Pn8eAGDE-G97rl6jGUnUoXdlcymqUGPxmz6Wp/pubhtml?gid=1011375499&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
                        </li>
                        <li>
                            <h5>Cà Mau</h5>
                            <iframe style="width: 100%; height: 320px;" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTWgrGXor2Kkpl9b9BbOS7LJS-pVxv3XvdQk7GAWHYvw3FCz8CkD-KIkot0dfl2unbMOTvbJQGI43iw/pubhtml?gid=826969243&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
                        </li>
                        <li>
                            <h5>Kiên Giang</h5>
                            <iframe style="width: 100%; height: 320px;" scrolling="no" src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRfRWl5FLqagothETucUplXafsKacrYYtJVarJ0gffl1MvFXlkA2m7ZtkR58-pbDAl7WvM4byP2_qsy/pubhtml?gid=85697556&amp;single=true&amp;widget=true&amp;headers=false"></iframe>
                        </li>
                    </ul>
                </div>
            </li>
            <li id="HQ7">
                <button type="button" id="collapsible" class="collapsible">Biểu diễn chuyển dịch trong tương lai khu vực phân bố tác nhân gây suy thoái chất lượng sinh cảnh</button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
            ...
            <li id="HQ8">
                <button type="button" id="collapsible" class="collapsible">Mô tả thay đổi về mức độ tác động của nhân tố qua không gia</button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
                        <li><h5>Sóc Trăng</h5></li>
                        <li><h5>Cà Mau</h5></li>
            ...
            <li id="HQ10">
                <button type="button" id="collapsible" class="collapsible">Trọng số giữa các cặp tác động </button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
                        <li>
                            <h5>Sóc Trăng</h5>
            ...
            <li id="HQ11">
                <button type="button" id="collapsible" class="collapsible">Mức độ tác động tiêu cực lên sinh cảnh của các nhân tố tác động</button>
                <div id="content" class="content" style="width: 98.5%">
                    <ul>
                        <li>
                            <h5>Sóc Trăng</h5>
